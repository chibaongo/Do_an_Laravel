						...
						<form action="{{url('/search')}}" method="GET" style="display: flex;">
                            <div style="display: flex;flex-direction: column;justify-content: space-between;">
                                <div class="search_box pull-right" style="margin-left: 10px;">
                                    <input type="text" id="nameSearch" name="name" placeholder="Tìm kiếm theo tên"/>
                                </div>
                                <div class="search_box pull-right"  style="margin-left: 10px;">
                                    <input type="text"  id="descriptionSearch" name="description" placeholder="Mô tả"/>
                                </div>
                            </div>
                            <div style="display: flex;flex-direction: column;justify-content: space-between;">
                                ...
                                <div class="search_box pull-right"  style="margin-left: 10px;">
                                    <input type="text" style="width: 250px;"  id="typeSearch" name="type" placeholder="Loại sản phẩm"/>
                                </div>
                            </div>
                            <button class="btn btn-primary" id="search" style="margin: 0 0 0 10px;" type="submit">Search</button>
                        </form>
					</div>
				</div>
			</div>
		...
		<div class="footer-top">
			<div class="container">
				<div class="row">
					...
					<div class="col-sm-3">
						<div class="address">
							<img src="user/images/home/map.png" alt="" />
